...
|-------|-----------|----------|
| **24 mrt 2026** | **Freemium: eliminatie alleen betaald + Judoka zoekfilters.** Eliminatie systeem + instellingen (dubbel/IJF) verborgen voor free tier, upgrade hint getoond. Upgrade pagina uitgebreid met eliminatie + print + noodplan als voordelen. Judoka zoekfunctie: geboortejaar filter (`2015`, `2015-2018`, `-2015`, `+2017`), geslacht (`mannen`/`vrouwen`), status (`aanwezig`/`afwezig`/`gewogen`/`nietgewogen`/`onvolledig`). Server symlink structuur (repo-prod/repo-staging). AutoFix meldingen afgehandeld (sessie perms, wimpel migratie was timing). | FREEMIUM.md |
