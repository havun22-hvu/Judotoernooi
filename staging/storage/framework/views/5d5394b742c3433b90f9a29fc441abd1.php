...
<head>
    ...
    <title><?php echo e(__('Inloggen')); ?> - <?php echo e(__('JudoToernooi')); ?></title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800"><?php echo e(__('JudoToernooi')); ?></h1>
        </div>
            ...
            <form action="<?php echo e(route('login.submit')); ?>" method="POST" id="loginForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="email"
                           ...
                           required
                           autofocus
                           class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between mb-6">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Onthoud mij')); ?></span>
                    </label>
            ...
            <div class="flex items-center my-6">
                ...
                <span class="px-4 text-sm text-gray-500"><?php echo e(__('of')); ?></span>
                <div class="flex-1 border-t border-gray-300"></div>
            </div>
            ...
            <div id="alt-login-methods">
                ...
                <button type="button" id="qr-login-btn" onclick="toggleQrModal()"
                    ...
                    <?php echo e(__('Inloggen met QR code')); ?>
                ...
                <button type="button" id="biometric-login-btn" onclick="startBiometric()"
                    ...
                    <?php echo e(__('Inloggen met biometrie')); ?>
        ...
        <div id="register-tab" class="hidden">
            <form action="<?php echo e(route('register.submit')); ?>" method="POST" id="registerForm">
                <?php echo csrf_field(); ?>

                <div class="mb-4">
                    <label for="reg-organisatie" class="block text-sm font-medium text-gray-700 mb-1">
                        <?php echo e(__('Naam judoschool / organisatie')); ?>

                    </label>
                    <input type="text"
                           id="reg-organisatie"
                           name="organisatie_naam"
                           value="<?php echo e(old('organisatie_naam')); ?>"
                           required
                           placeholder="<?php echo e(__('Naam van uw judoschool')); ?>"
                           class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['organisatie_naam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    <label for="reg-naam" class="block text-sm font-medium text-gray-700 mb-1">
                        <?php echo e(__('Uw naam')); ?> <span class="text-gray-400">(<?php echo e(__('contactpersoon')); ?>)</span>
                    </label>
                    <input type="text"
                           id="reg-naam"
                           name="naam"
                           value="<?php echo e(old('naam')); ?>"
                           required
                           placeholder="<?php echo e(__('bijv. Jan Jansen')); ?>"
                           class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['naam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    <label for="reg-telefoon" class="block text-sm font-medium text-gray-700 mb-1">
                        <?php echo e(__('Telefoonnummer')); ?> <span class="text-gray-400">(<?php echo e(__('optioneel')); ?>)</span>
                    </label>
                    <input type="tel"
                           id="reg-telefoon"
                           name="telefoon"
                           value="<?php echo e(old('telefoon')); ?>"
                ...
                <button type="submit" id="register-btn"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors">
                    <?php echo e(__('Registratielink versturen')); ?>

                </button>

                <p class="text-xs text-gray-500 text-center mt-3">
                    <?php echo e(__('We sturen een activatielink naar je e-mailadres.')); ?>
    ...
    <div id="qr-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50" onclick="if(event.target === this) toggleQrModal()">
        <div class="bg-white rounded-2xl p-6 m-4 max-w-sm w-full shadow-2xl">
            <div class="flex justify-between items-center mb-4">
                <h3 class="font-semibold text-gray-800"><?php echo e(__('Scan met je telefoon')); ?></h3>
            ...
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-2"><?php echo e(__('Scan met je telefoon waarop je al bent ingelogd')); ?></p>
                <p id="qr-status" class="text-xs text-gray-400"><?php echo e(__('QR code laden...')); ?></p>
                <p id="qr-timer" class="text-xs text-blue-500 hidden mt-1"><?php echo e(__('Verloopt over')); ?> <span id="timer">5:00</span></p>
            </div>
        </div>
    </div>
...
<script>
const __t = {
    somethingWrong: <?php echo json_encode(__('Er ging iets mis'), 15, 512) ?>,
    biometricNotSupported: <?php echo json_encode(__('Biometrie niet ondersteund op dit apparaat'), 15, 512) ?>,
    noPasskeyFound: <?php echo json_encode(__('Geen passkey gevonden. Log eerst in met wachtwoord.'), 15, 512) ?>,
    biometricFailed: <?php echo json_encode(__('Biometrie mislukt. Gebruik je wachtwoord.'), 15, 512) ?>,
    qrLoading: <?php echo json_encode(__('QR code laden...'), 15, 512) ?>,
    scanWithPhone: <?php echo json_encode(__('Scan met je telefoon'), 15, 512) ?>,
    qrLoadFailed: <?php echo json_encode(__('QR laden mislukt'), 15, 512) ?>,
    approved: <?php echo json_encode(__('Goedgekeurd! Doorsturen...'), 15, 512) ?>,
    refreshQr: <?php echo json_encode(__('Vernieuw QR'), 15, 512) ?>,
    qrExpired: <?php echo json_encode(__('QR code verlopen'), 15, 512) ?>,
    registering: <?php echo json_encode(__('Bezig met versturen...'), 15, 512) ?>,
};
...
(async function() {
    ...
    <?php if($errors->has('organisatie_naam') || $errors->has('naam') || $errors->has('telefoon')): ?>
    switchTab('register');
    <?php endif; ?>
})();
</script>
...
<?php /**PATH /var/www/judotoernooi/staging/resources/views/organisator/auth/login.blade.php ENDPATH**/ ?>