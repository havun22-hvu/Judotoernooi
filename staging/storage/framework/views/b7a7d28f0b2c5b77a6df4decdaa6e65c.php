...
(function() {
    const matUpdateConfig = {
        ...
        matId: <?php echo e($matId ?? 'null'); ?>,
        reverbHost: '<?php echo e(parse_url(config("app.url"), PHP_URL_HOST)); ?>',
        reverbPort: <?php echo e($reverbPort); ?>,
        reverbKey: '<?php echo e($reverbKey); ?>',
        reverbScheme: '<?php echo e($reverbScheme); ?>'
    };
...
<?php /**PATH /var/www/judotoernooi/staging/resources/views/partials/mat-updates-listener.blade.php ENDPATH**/ ?>