<?php $__env->startSection('title', __('Weeglijst Live')); ?>

<?php $__env->startSection('content'); ?>
<div class="flex justify-between items-center mb-4">
    <h1 class="text-2xl font-bold text-gray-800">⚖️ <?php echo e(__('Weeglijst Live')); ?></h1>
    <div class="text-sm text-gray-500"><?php echo e(__('Auto-refresh 10s')); ?></div>
</div>
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <input type="text" x-model="zoekterm" @input="filterJudokas()"
                       placeholder="<?php echo e(__('Zoek naam of club...')); ?>"
                ...
                <select x-model="blokFilter" @change="filterJudokas()" class="border-2 border-gray-300 rounded px-3 py-2 font-medium">
                    <option value=""><?php echo e(__('Alle blokken')); ?></option>
                    <?php $__currentLoopData = $toernooi->blokken; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($blok->nummer); ?>" data-gesloten="<?php echo e($blok->weging_gesloten ? '1' : '0'); ?>"><?php echo e(__('Blok')); ?> <?php echo e($blok->nummer); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <select x-model="statusFilter" @change="filterJudokas()" class="border-2 border-gray-300 rounded px-3 py-2">
                    <option value=""><?php echo e(__('Alle status')); ?></option>
                    <option value="gewogen"><?php echo e(__('Gewogen')); ?></option>
                    <option value="niet_gewogen"><?php echo e(__('Niet gewogen')); ?></option>
                    <option value="afwezig"><?php echo e(__('Afwezig')); ?></option>
                </select>
                ...
                <template x-if="blokFilter !== '' && !blokGesloten[blokFilter]">
                    <button type="button"
                        ...
                        <?php echo e(__('Blok')); ?> <span x-text="blokFilter"></span>: <?php echo e(__('Einde weegtijd')); ?>

                    </button>
                </template>
                <template x-if="blokFilter !== '' && blokGesloten[blokFilter]">
                    <span class="text-gray-500 px-4 py-2"><?php echo e(__('Blok')); ?> <span x-text="blokFilter"></span>: <?php echo e(__('Gesloten')); ?></span>
                </template>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="text-center w-28 transition-opacity"
                     :class="blokFilter !== '' && blokFilter != '<?php echo e($blok->nummer); ?>' ? 'opacity-40' : ''">
                    <div class="text-xs text-gray-500"><?php echo e(__('Blok')); ?> <?php echo e($blok->nummer); ?></div>
                    <div class="text-lg font-bold">
                        <span class="text-green-600" x-text="stats.blok<?php echo e($blok->nummer); ?>?.gewogen || 0"></span>
                        <span class="text-gray-400">/</span>
                        <span class="text-gray-600" x-text="stats.blok<?php echo e($blok->nummer); ?>?.totaal || 0"></span>
                    </div>
                    <?php if($blok->weging_gesloten): ?>
                    <div class="text-xs text-gray-500"><?php echo e(__('Gesloten')); ?></div>
                    <?php elseif($blok->weging_einde && $toernooi->datum?->isToday()): ?>
                    <div x-data="countdown('<?php echo e($blok->weging_start?->toISOString()); ?>', '<?php echo e($blok->weging_einde->toISOString()); ?>', <?php echo e($blok->nummer); ?>)" x-init="start()"
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="w-full table-fixed">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Naam')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Club')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Leeftijd')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Opgegeven')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Blok')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Gewogen')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Tijd')); ?></th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Actie')); ?></th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
                ...
                <tr x-show="gefilterd.length === 0">
                    <td colspan="8" class="px-4 py-8 text-center text-gray-500">
                        <?php echo e(__("Geen judoka's gevonden")); ?>
        ...
        <div class="absolute bg-white rounded-lg shadow-xl w-80 pointer-events-auto"
            ...
            <div class="p-4 border-b cursor-move select-none bg-gray-50 rounded-t-lg"
                ...
                <div class="flex justify-between items-center">
                    <h3 class="text-lg font-bold text-gray-800"><?php echo e(__('Gewicht wijzigen')); ?></h3>
            ...
            <div class="p-4">
                <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('Gewogen gewicht')); ?> (kg)</label>
                ...
                <p class="text-xs text-gray-500 mt-1"><?php echo e(__('Tip: 0 = afmelden (kan niet deelnemen)')); ?></p>
            </div>
            <div class="p-4 border-t flex gap-2">
                <button @click="markeerAfwezig()" :disabled="editSaving"
                    ...
                    <?php echo e(__('Afmelden (kan niet deelnemen)')); ?>
                ...
                <button @click="saveGewicht()" :disabled="editSaving"
                    ...
                    <span x-show="!editSaving"><?php echo e(__('Opslaan')); ?></span>
                    <span x-show="editSaving"><?php echo e(__('Bezig...')); ?></span>
                </button>
            </div>
        </div>
    </div>
...
<script>
const __t = {
    confirmCloseBlock: <?php echo json_encode(__('Weegtijd Blok :blok sluiten? Niet-gewogen judoka\'s worden als afwezig gemarkeerd.'), 15, 512) ?>,
    saveError: <?php echo json_encode(__('Fout bij opslaan'), 15, 512) ?>,
};
...
function weeglijst() {
    return {
        judokas: <?php echo json_encode($judokas, 15, 512) ?>,
        gefilterd: [],
        zoekterm: '',
        blokFilter: '',
        statusFilter: '',
        blokGesloten: {
            <?php $__currentLoopData = $toernooi->blokken; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($blok->nummer); ?>: <?php echo e($blok->weging_gesloten ? 'true' : 'false'); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        },
        blokIds: {
            <?php $__currentLoopData = $toernooi->blokken; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($blok->nummer); ?>: <?php echo e($blok->id); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        },
        stats: {
            totaal: 0,
            ...
            percentage: 0,
            <?php $__currentLoopData = $toernooi->blokken; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            blok<?php echo e($blok->nummer); ?>: { totaal: 0, gewogen: 0 },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        },
        ...
        sluitWeegtijd() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(url()->current()); ?>'.replace('/weging/interface', '/blok/' + blokId + '/sluit-weging');
        ...
        berekenStats() {
            ...
            // Per blok
            <?php $__currentLoopData = $toernooi->blokken; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            const blok<?php echo e($blok->nummer); ?> = this.judokas.filter(j => j.blok == <?php echo e($blok->nummer); ?>);
            this.stats.blok<?php echo e($blok->nummer); ?> = {
                totaal: blok<?php echo e($blok->nummer); ?>.length,
                gewogen: blok<?php echo e($blok->nummer); ?>.filter(j => j.gewogen).length
            };
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        },
        ...
        async refresh() {
            try {
                const response = await fetch('<?php echo e(route('toernooi.weging.lijst-json', $toernooi->routeParams())); ?>');
        ...
        async saveGewicht() {
            ...
            try {
                const response = await fetch(`<?php echo e(url()->current()); ?>`.replace('/weging/interface', `/weging/${this.editJudoka.id}/registreer`), {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/judotoernooi/staging/resources/views/pages/weging/interface-admin.blade.php ENDPATH**/ ?>