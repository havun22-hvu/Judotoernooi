...
<div class="absolute w-32 bracket-potje"
    ...
    {{-- Wit slot (boven) --}}
    <div class="relative">
        <div class="w-32 h-10 bg-white border border-gray-300 rounded-l flex items-center text-xs drop-slot bracket-drop {{ !$isLastRound ? 'border-r-0' : '' }}"
             id="slot-{{ $wed['id'] }}-wit"
    ...
    {{-- Blauw slot (onder) --}}
    <div class="relative">
        <div class="w-32 h-10 bg-blue-50 border border-gray-300 rounded-l flex items-center text-xs drop-slot bracket-drop {{ !$isLastRound ? 'border-r-0' : '' }}"
