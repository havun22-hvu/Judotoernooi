...
| **.claude/** | Cursor/Claude context: context.md, handover.md, features.md, deploy.md, mollie.md, smallwork.md, commands/, handover/, archive/ |
...
- **Docs-map**: 1-GETTING-STARTED, 2-FEATURES (incl. ELIMINATIE/), 3-TECHNICAL, 3-DEVELOPMENT, 4-PLANNING, 4-SEO, 5-REGLEMENT, 6-INTERNAL; URL-STRUCTUUR.md in docs-root.
