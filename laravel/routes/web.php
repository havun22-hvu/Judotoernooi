...
use App\Http\Controllers\MatBracketController;
use App\Http\Controllers\MatController;
use App\Http\Controllers\MatUitslagController;
...
Route::prefix('{organisator}')->middleware('auth:organisator')->group(function () {
    ...
    Route::post('wimpeltoernooi/{stamJudoka}/handmatig-uitreiken', [WimpelController::class, 'handmatigUitreiken'])->name('organisator.wimpel.handmatig-uitreiken');
...
Route::prefix('{organisator}/toernooi/{toernooi}')->middleware(['auth:organisator', EnsureToernooiScope::class])->name('toernooi.')->group(function () {
    ...
    Route::middleware(CheckToernooiRol::class . ':mat')->group(function () {
        ...
        Route::post('mat/uitslag', [MatUitslagController::class, 'registreerUitslag'])->name('mat.uitslag');
        Route::post('mat/poule-klaar', [MatUitslagController::class, 'pouleKlaar'])->name('mat.poule-klaar');
        Route::post('mat/huidige-wedstrijd', [MatUitslagController::class, 'setHuidigeWedstrijd'])->name('mat.huidige-wedstrijd');
        Route::post('mat/plaats-judoka', [MatBracketController::class, 'plaatsJudoka'])->name('mat.plaats-judoka');
        Route::post('mat/verwijder-judoka', [MatBracketController::class, 'verwijderJudoka'])->name('mat.verwijder-judoka');
        Route::post('mat/finale-uitslag', [MatUitslagController::class, 'finaleUitslag'])->name('mat.finale-uitslag');
...
// Public mobile scoreboard — public, no auth (parents/coaches follow live score on phone via link/QR)
Route::get('{organisator}/{toernooi}/mat/scoreboard-mobiel/{mat}', [MatController::class, 'scoreboardMobile'])->name('mat.scoreboard-mobile');
...
Route::prefix('{organisator}/{toernooi}')->group(function () {
    ...
    Route::middleware('device.binding')->group(function () {
        ...
        Route::post('mat/{toegang}/uitslag', [MatUitslagController::class, 'registreerUitslagDevice'])->name('mat.uitslag.device');
        Route::post('mat/{toegang}/huidige-wedstrijd', [MatUitslagController::class, 'setHuidigeWedstrijdDevice'])->name('mat.huidige-wedstrijd.device');
        Route::post('mat/{toegang}/poule-klaar', [MatUitslagController::class, 'pouleKlaarDevice'])->name('mat.poule-klaar.device');
        ...
        Route::post('mat/{toegang}/advance-byes', [MatBracketController::class, 'advanceByesDevice'])->name('mat.advance-byes.device');
        Route::post('mat/{toegang}/plaats-judoka', [MatBracketController::class, 'plaatsJudokaDevice'])->name('mat.plaats-judoka.device');
        Route::post('mat/{toegang}/verwijder-judoka', [MatBracketController::class, 'verwijderJudokaDevice'])->name('mat.verwijder-judoka.device');
        Route::post('mat/{toegang}/finale-uitslag', [MatUitslagController::class, 'finaleUitslagDevice'])->name('mat.finale-uitslag.device');
