...
Route::prefix('toernooi/{toernooi}')->name('toernooi.')->group(function () {
    ...
    Route::middleware(CheckToernooiRol::class . ':admin')->group(function () {
        ...
        Route::post('poule/kies-variant', [PouleController::class, 'kiesVariant'])->name('poule.kies-variant');
        ...
        Route::post('blok/maak-weegkaarten', [BlokController::class, 'maakWeegkaarten'])->name('blok.maak-weegkaarten');
