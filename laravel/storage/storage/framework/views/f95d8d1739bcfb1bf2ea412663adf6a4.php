...
<div id="chat-panel"
    ...
    <div class="bg-blue-800 text-white p-4 flex items-center justify-between">
        <div>
            <h2 class="font-bold text-lg"><?php echo e(__('Hoofdjury Chat')); ?></h2>
            <p class="text-blue-200 text-sm"><?php echo e(__('Communicatie met vrijwilligers')); ?></p>
        </div>
    ...
    <div class="bg-gray-100 border-b p-3">
        <label class="text-xs font-medium text-gray-600 block mb-2"><?php echo e(__('Verstuur naar:')); ?></label>
        ...
        <?php if($aantalMatten > 0): ?>
        <div class="mt-2 pt-2 border-t border-gray-200">
            <label class="text-xs font-medium text-gray-500 block mb-2"><?php echo e(__('Individuele mat:')); ?></label>
            <div class="flex flex-wrap gap-2">
                <?php for($i = 1; $i <= $aantalMatten; $i++): ?>
                <button type="button" onclick="setRecipient('mat', <?php echo e($i); ?>)"
                        class="recipient-btn px-3 py-1.5 rounded-full text-sm font-medium border-2 transition-colors"
                        data-type="mat" data-id="<?php echo e($i); ?>">
                    <?php echo e(__('Mat')); ?> <?php echo e($i); ?>
    ...
    <div id="chat-messages" class="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
        <div id="chat-empty" class="text-center text-gray-500 py-8">
            ...
            <p><?php echo e(__('Nog geen berichten')); ?></p>
        </div>
    </div>
    ...
    <div class="border-t bg-white p-4">
        <div id="recipient-display" class="text-xs text-blue-600 font-medium mb-2">
            <?php echo e(__('Naar:')); ?> <span id="recipient-label"><?php echo e(__('Selecteer ontvanger')); ?></span>
        </div>
        <form id="chat-form" onsubmit="sendMessage(event)" class="flex gap-2">
            <input type="text"
                   id="chat-input"
                   placeholder="<?php echo e(__('Typ een bericht...')); ?>"
...
<div id="chat-toast"
    ...
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
            <p id="chat-toast-sender" class="font-bold text-sm"><?php echo e(__('Mat')); ?> 1</p>
            <p id="chat-toast-message" class="text-blue-100 text-sm truncate"><?php echo e(__('Nieuw bericht')); ?></p>
        </div>
...
<script>
    ...
    const chatConfig = {
        type: 'hoofdjury',
        id: null,
        toernooiId: <?php echo e($toernooiId ?? 'null'); ?>,
        apiBase: '<?php echo e(route('toernooi.chat.index', $toernooi->routeParams())); ?>'
    };
    ...
    const recipientLabels = {
        'iedereen': '<?php echo e(__('Iedereen')); ?>',
        'alle_matten': '<?php echo e(__('Alle Matten')); ?>',
        'weging': '<?php echo e(__('Weging')); ?>',
        'spreker': '<?php echo e(__('Spreker')); ?>',
        'dojo': '<?php echo e(__('Dojo')); ?>',
        'mat': '<?php echo e(__('Mat')); ?>'
    };
    ...
    async function sendMessage(event) {
        ...
        if (!selectedRecipient.type) {
            alert('<?php echo e(__('Selecteer eerst een ontvanger')); ?>');
            return;
        }
        ...
        try {
            ...
            alert('<?php echo e(__('Bericht versturen mislukt. Probeer opnieuw.')); ?>');
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        loadMessages();
        <?php if(config('broadcasting.default') === 'reverb'): ?>
        setupWebSocket();
        <?php endif; ?>
    });
    ...
    function initEcho() {
        ...
        const pusher = new Pusher('<?php echo e(env("REVERB_APP_KEY", "oixj1bggwjv8qhj3jlpb")); ?>', {
...
<?php /**PATH /var/www/judotoernooi/staging/resources/views/partials/chat-widget-hoofdjury.blade.php ENDPATH**/ ?>