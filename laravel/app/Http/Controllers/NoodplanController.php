    ...
    public function downloadOfflinePakket(Organisator $organisator, Toernooi $toernooi)
    {
        ...
        $data = [
            'toernooi' => [
                ...
                'heeft_eigen_router' => (bool) $toernooi->heeft_eigen_router,
                'eigen_router_ssid' => $toernooi->eigen_router_ssid,
                'eigen_router_wachtwoord' => $toernooi->eigen_router_wachtwoord,
                'hotspot_ssid' => $toernooi->hotspot_ssid,
                'hotspot_wachtwoord' => $toernooi->hotspot_wachtwoord,
                'local_server_primary_ip' => $toernooi->local_server_primary_ip,
                'local_server_standby_ip' => $toernooi->local_server_standby_ip,
            ],
