...
/**
 * Handles wedstrijddag poule management — verplaats judoka, doorsturen
 * naar zaaloverzicht, nieuwe poule, type wijzigen. Mobile views and
 * judoka mutations (afmelden/toevoegen/herstellen) live in
 * WedstrijddagMobielController.
 */
class WedstrijddagController extends Controller
{
    public function poules(Organisator $organisator, Toernooi $toernooi): View
    {
        ...
        // poules.judokas + poules.toernooi zijn eager-loaded om N+1 te vermijden.
