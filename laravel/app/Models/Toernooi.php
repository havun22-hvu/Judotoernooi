...
class Toernooi extends Model
{
    ...
    /**
     * OWFJ2026 - Open Westfries Judotoernooi 2026
     * Specifieke preset van Cees Veen
     * Band-scheiding per categorie, vaste gewichtsklassen
     */
    public static function getOwfj2026Gewichtsklassen(): array
    {
        return [
            // U7 Mini's - gemengd, geen band scheiding
            'u7' => [
                'label' => "Mini's U7",
                'max_leeftijd' => 6,
                'geslacht' => 'gemengd',
            ...
            'u9_wit' => [
                ...
                'band_van' => 'wit',
                'band_tot' => 'wit',
                'gewichten' => ['-24', '-27', '-30', '-34', '-38', '-42', '+46'],
                'max_gewicht' => 50,
            ],
            // U9 Vanaf gele band - gemengd
            'u9_geel_plus' => [
                'label' => 'U9 Geel+',
                'max_leeftijd' => 8,
                'geslacht' => 'gemengd',
            ...
            // U11 Witte band - gemengd
            'u11_wit' => [
                'label' => 'U11 Witte band',
                'max_leeftijd' => 10,
                'geslacht' => 'gemengd',
                'band_van' => 'wit',
                'band_tot' => 'wit',
            ...
            // U15 Heren wit t/m oranje
            'u15_h_wit_oranje' => [
                'label' => 'U15 Heren Wit-Oranje',
                'max_leeftijd' => 14,
                'geslacht' => 'M',
                'band_van' => 'wit',
                'band_tot' => 'oranje',
            ...
            // U15 Heren vanaf groen
            'u15_h_groen_plus' => [
                'label' => 'U15 Heren Groen+',
                'max_leeftijd' => 14,
                'geslacht' => 'M',
                'band_van' => 'groen',
                'band_tot' => 'zwart',
            ...
            // U15 Dames wit t/m oranje
            'u15_d_wit_oranje' => [
                'label' => 'U15 Dames Wit-Oranje',
                'max_leeftijd' => 14,
                'geslacht' => 'V',
                'band_van' => 'wit',
                'band_tot' => 'oranje',
            ...
            // U15 Dames vanaf groen
            'u15_d_groen_plus' => [
                'label' => 'U15 Dames Groen+',
                'max_leeftijd' => 14,
                'geslacht' => 'V',
                'band_van' => 'groen',
                'band_tot' => 'zwart',
