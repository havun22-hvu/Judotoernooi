...
<body class="bg-white sm:bg-gray-100 min-h-screen flex items-center justify-center p-0 sm:p-4">
    <div class="bg-white p-6 sm:p-8 w-full sm:max-w-md min-h-screen sm:min-h-0 flex flex-col justify-center sm:block sm:rounded-lg sm:shadow-xl">
        ...
        <div class="flex justify-end mb-2" x-data="toggle">
            <div class="relative">
                <button @click="toggle()" class="flex items-center text-gray-500 hover:text-gray-700 text-sm focus:outline-none">
                    @include('partials.flag-icon', ['lang' => app()->getLocale()])
                    <svg class="ml-1 w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                    </svg>
                </button>
                <div x-show="open" @click.outside="close()" x-transition class="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg py-1 z-50 border">
            ...
            <form action="{{ route('login.submit') }}" method="POST" id="loginForm">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggle-password" data-action="toggle-pw" data-target="password" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700">
