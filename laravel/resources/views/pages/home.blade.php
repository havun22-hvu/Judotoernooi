...
<body class="bg-white min-h-screen">
    ...
    <section class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 pt-10 md:pt-20 pb-10 text-center relative z-1">
                <p class="text-blue-300 font-medium mb-4 text-sm uppercase tracking-wider">{{ __('Toernooi Management Software') }}</p>
        ...
        <!-- Scroll indicator -->
        <div class="text-center pt-16 pb-8 relative z-1">
