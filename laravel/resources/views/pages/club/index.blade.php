        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50 {{ $isUitgenodigd ? 'bg-green-50' : '' }}">
                <td class="px-4 py-3">
                    ...
                    {{-- Club heeft judoka's, kan niet uitgeschakeld worden --}}
                    <div class="w-6 h-6 rounded border-2 flex items-center justify-center bg-green-500 border-green-500 text-white cursor-not-allowed opacity-60"
                         title="Kan niet uitschakelen: er zijn {{ $club->judokas_count }} judoka's ingeschreven">
