...
@section('title', __('Upgrade Vereist') . ' - ' . $toernooi->naam)
...
<div class="max-w-2xl mx-auto text-center">
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-4">{{ $feature ?? __('Deze functie') }} - {{ __('Upgrade Vereist') }}</h1>
        ...
        <ul class="text-left bg-green-50 border border-green-200 rounded-lg p-4 mb-6 text-sm text-green-700 space-y-2">
            <li class="flex items-center">
                ...
                {{ __("Print weegkaarten, coachkaarten en wedstrijdschema's") }}
            </li>
            <li class="flex items-center">
                <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                </svg>
                {{ __('Noodplan backup voor offline werken') }}
            </li>
            <li class="flex items-center">
                <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                </svg>
                {{ __('Export naar Excel/PDF') }}
            </li>
            <li class="flex items-center">
                <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                </svg>
                {{ __("Meer judoka's (tot 500)") }}
            </li>
        </ul>

        <div class="flex justify-center space-x-4">
            <a href="{{ route('toernooi.upgrade', $toernooi->routeParams()) }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg">
                {{ __('Upgrade Nu') }}
            </a>
            <a href="{{ route('toernooi.show', $toernooi->routeParams()) }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 px-6 rounded-lg">
