...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">{{ __('Eliminatie brackets') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('Printbare brackets per eliminatie-poule') }}</p>
        </div>
    ...
    {{-- Leeg-op-maat invul-formulier --}}
    <form method="GET" action="{{ route('toernooi.noodplan.bracket-leeg', array_merge($toernooi->routeParams(), ['aantal' => 8])) }}"
          x-data="{ aantal: 8 }"
