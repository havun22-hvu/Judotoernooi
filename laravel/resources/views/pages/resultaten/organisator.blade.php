    ...
    <header class="bg-blue-600 text-white py-4 no-print">
        <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <button data-action="print" class="bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-50 flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                    Printen
                </button>
                @if($toernooi->danpunten_actief)
                <a href="{{ route('export-danpunten', $toernooi->routeParams()) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-yellow-600 flex items-center gap-2">
