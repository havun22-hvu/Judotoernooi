...
@if($groep === 'A')
    <div class="relative flex-shrink-0 w-32">
        {{-- Goud (1e plaats) --}}
        <div class="absolute w-32" data-bracket-top="{{ $medailleData['goud']['top'] }}">
        ...
        {{-- Zilver (2e plaats) --}}
        <div class="absolute w-32" data-bracket-top="{{ $medailleData['zilver']['top'] }}">
...
@else
    ...
    <div class="relative flex-shrink-0 w-32">
        @if(isset($medailleData['brons_1']))
            <div class="absolute w-32" data-bracket-top="{{ $medailleData['brons_1']['top'] }}">
        ...
        @if(isset($medailleData['brons_2']))
            <div class="absolute w-32" data-bracket-top="{{ $medailleData['brons_2']['top'] }}">
                <div class="w-32 h-9 bg-amber-100 border border-amber-400 rounded flex items-center px-1 text-xs truncate bracket-drop bracket-medal"
