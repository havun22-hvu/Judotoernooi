...
<div class="mb-8">
    <div class="flex justify-between items-start">
        ...
        <div class="flex items-center space-x-2">
            <a href="{{ route('toernooi.wedstrijddag.mobiel', $toernooi->routeParams()) }}" class="bg-blue-100 hover:bg-blue-200 text-blue-700 px-4 py-2 rounded-lg flex items-center">
