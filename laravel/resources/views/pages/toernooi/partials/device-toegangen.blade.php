                    ...
                    <div class="p-4 border rounded-lg bg-gray-50">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div x-show="tvLinkVisible(toegang)" x-cloak
                                ...
                                <p class="text-xs text-gray-500 mb-3">{{ __('Open') }} <strong>{{ app()->environment('production') ? 'havun.nl/tv' : preg_replace('#^https?://#', '', url('tv')) }}</strong> {{ __('op de TV. Voer de code in die op het TV-scherm verschijnt:') }}</p>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('deviceToegangen', () => ({
        ...
        urls: {
            ...
            tvBase: @json(app()->environment('production') ? 'https://havun.nl/tv' : url('tv')),
