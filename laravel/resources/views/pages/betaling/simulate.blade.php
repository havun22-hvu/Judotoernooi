...
<head>
    ...
    <title>Betaling Simulatie - iDEAL</title>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-pink-500 to-pink-600 p-6 text-white">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm opacity-75">Simulatie</div>
                </div>
            </div>

            <div class="p-6">
                <div class="text-center mb-6">
                    <p class="text-gray-600 mb-2">Betaling voor:</p>
                    <p class="font-bold text-lg">{{ $betaling?->toernooi?->naam ?? 'Onbekend toernooi' }}</p>
                    @if($betaling)
                ...
                <div class="border-t pt-6">
                    <p class="text-sm text-gray-600 mb-4 text-center">
                        Dit is een <strong>simulatie</strong>. In productie wordt je doorgestuurd naar je bank.
                    </p>
            ...
            <div class="bg-gray-50 px-6 py-3 text-center text-xs text-gray-500">
                JudoToernooi - Staging Betaling Simulatie
            </div>
        </div>
    </div>
</body>
